/* =========================================================================
 * ECCHIPS SMD Code Lookup — deterministic data tables
 * =========================================================================
 * Rule (spec §26): deterministic algorithms over AI. Official sources over
 * third-party. No AI-generated component parameters.
 *
 * EIA-96 significant-value table (values 01–96), and the standard
 * multiplier letter set Z Y X A B C D E F.
 * ========================================================================= */

export const EIA96_VALUES = {
...
/* Standard EIA-96 multiplier letters (IEC 60062). */
