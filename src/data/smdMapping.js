/* =========================================================================
 * ECCHIPS SMD Code Lookup — deterministic mapping data
 * =========================================================================
 * Accuracy rule: deterministic data over AI. No guessed parameters.
 *
 * EIA-96 significant-value table (index "01"–"96") and the standard
 * multiplier letter set Z Y X A B C D E F (IEC 60062 convention).
 * ========================================================================= */
...
/* Standard EIA-96 multiplier letters → multiplier value. */
